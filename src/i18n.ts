...
const PT: UiCopy = {
  ...
  title: 'Pipeview',
  lede: 'Um painel da esteira real por detrás deste site: GitHub Actions e um Worker na Cloudflare. Pode abrir cada etapa para ver o que corre — lint, security, testes e build.',
  viewActions: 'Ver no Actions',
  repository: 'Repositório',
  thisDeploy: 'Este deploy',
  gitSha: 'Git SHA',
  builtAt: 'Publicado em',
  edgeClock: 'Relógio na edge',
  cfRay: 'CF-Ray',
  openRunLink: 'Abrir o workflow que publicou este build →',
  conveyorHeading: 'Esteira ao vivo',
  runLiveDemo: 'Iniciar uma demo ao vivo',
  runningDemo: 'Demo em curso…',
  demoQueued: 'Workflow na fila…',
  demoFailed: 'A demo encontrou um erro',
  aiReview: 'Pedir revisão por IA',
  aiReviewing: 'A pedir análise ao Edge Labs…',
  aiReviewTitle: 'Leitura da IA sobre o erro',
  ...
  probingEdge: 'a verificar a edge…',
  edgeOk: 'edge ok',
  ...
  liveSteps: 'Etapas deste run',
  viewLog: 'Ver registo',
  loadingLog: 'A carregar o registo…',
  logTruncated:
    'Registo truncado (últimas linhas, máx. 32 KiB) — secrets redactados.',
  logUnavailable:
    'Esta etapa não tem job neste live-demo (staging/prod ficam no deploy.yml).',
  nodeNotInRun: 'Esta etapa não correu neste live-demo.',
