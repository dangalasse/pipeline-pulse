...
Portfolio proof for **SRE / DevOps**: a readable Actions tab, PR previews, staging smoke, live demo conveyor, and a protected production gate — hosted on the edge, not SSH to a box.
